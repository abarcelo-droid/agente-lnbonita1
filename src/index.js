...
import etlClientesSgRouter from "./rutas/_etlClientesSg.js"; // TEMPORAL #401 Paso 4 — remover tras verificar
...
app.use("/api/admin/_etl-clientes", etlClientesSgRouter); // TEMPORAL #401 Paso 4 — remover tras verificar
